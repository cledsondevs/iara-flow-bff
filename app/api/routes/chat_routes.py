...
# from app.services.groq_chat_service import GroqChatService  # TEMPORARIAMENTE DESABILITADO
...
# groq_service = GroqChatService()  # TEMPORARIAMENTE DESABILITADO
...
# @cross_origin()
# def groq_chat():
#     """Endpoint para conversar com o Groq com memória de longo prazo - TEMPORARIAMENTE DESABILITADO"""
#     return jsonify({"error": "Serviço Groq temporariamente indisponível"}), 503
...
# @cross_origin()
# def get_groq_memory():
#     """Recuperar memória do chat Groq para um usuário específico - TEMPORARIAMENTE DESABILITADO"""
#     return jsonify({"error": "Serviço Groq temporariamente indisponível"}), 503
...
#     """Limpar memória do chat Groq para um usuário específico - TEMPORARIAMENTE DESABILITADO"""
#     return jsonify({"error": "Serviço Groq temporariamente indisponível"}), 503
...
def health_check():
    ...
    return jsonify({
        ...
        "note": "Serviço Groq temporariamente desabilitado",
        "timestamp": datetime.utcnow().isoformat()
    }), 200
...
# @cross_origin()
# def get_groq_models():
#     """Endpoint para listar modelos disponíveis no Groq - TEMPORARIAMENTE DESABILITADO"""
#     return jsonify({"error": "Serviço Groq temporariamente indisponível"}), 503
